        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-center">
                    <img src="../assets/images/banner/banner1.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="../assets/images/banner/banner2.jpg" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
            ...
            <div class="row order-section">
                <div class="col-sm-6 p-0">
                    <div class="contain-block even new-block">
                        <div>
                            <a href="#">
                                <h3>Learn How to Layer Our Products</h3>
                            </a>
                            <h6>Layering basically means to apply your skincare products in a specific order of application, to achieve optimum efficacy from each active.</h6>
                            <a href="#" class="btn btn-solid category-btn">LEARN MORE</a>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 p-0">
                    <a href="#" class="image-block new-image-banner"><img alt="" src="../assets/images/banner/banner3.jpg" class="img-fluid lazyload bg-img"></a>
                </div>
                <!--<div class="col-sm-6 p-0">
                    <a href="#" class="image-block"><img alt="" src="../assets/images/banner/banner3.jpg" class="img-fluid blur-up lazyload bg-img"></a>
                </div>
                <div class="col-sm-6 p-0">
                    <div class="contain-block even new-block">
                        <div>
                            <a href="#">
                                <h3><uppercase>FACE MASK FINDER</uppercase></h3>
                            </a>
                            <h6>Discover the best face mask for your skin, take our quick quiz to discover which of our botanic masks will help resolve your skin concerns!</h6>
                            <a href="#" class="btn btn-solid category-btn"><uppercase>TAKE OUR QUIZ</uppercase></a>
                            </a>
                        </div>
                    </div>
                </div>-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="#">
                        <h5 class="title-borderless">READ MORE</h5>
                    </a>
                    <div class="slide-5 no-arrow slick-instagram">
                        <div>
                            <div class="instagram-box"><img src="../assets/images/banner/tab1.jpg" class="bg-img"
                                    alt="Avatar" style="width:100%">
                            </div>
                        </div>
                        <div>
                            <div class="instagram-box"><img src="../assets/images/banner/tab2.jpg" class="bg-img"
                                    alt="Avatar" style="width:100%">
                            </div>
                        </div>
                        <div>
                            <div class="instagram-box"><img src="../assets/images/banner/tab3.jpg" class="bg-img"
                                    alt="Avatar" style="width:100%">
                            </div>
                        </div>
                        <div>
                            <div class="instagram-box"><img src="../assets/images/banner/tab4.jpg" class="bg-img"
                                    alt="Avatar" style="width:100%">
                            </div>
                        </div>
                        <div>
                            <div class="instagram-box"><img src="../assets/images/banner/tab5.jpg" class="bg-img"
                                    alt="Avatar" style="width:100%">
                            </div>
                        </div>
                        <div>
                            <div class="instagram-box"><img src="../assets/images/banner/tab6.jpg" class="bg-img"
                                    alt="Avatar" style="width:100%">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title2">
                            <li class="current"><a href="tab-1">Best Seller</a></li>
                            <li class=""><a href="tab-2">What's New</a></li>
                                ...
                                <div class="product-4 product-m no-arrow">
                                        ...
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro1.jpg"
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro2.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro3.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro4.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro5.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro6.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro7.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro8.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro9.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                ...
                                <div class="product-4 product-m no-arrow">
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro10.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro11.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button tabindex="0" onclick="openCart()" title="Add to cart">
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro12.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro13.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro14.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button tabindex="0" onclick="openCart()" title="Add to cart">
                                    ...
                                    <div class="product-box">
                                        <div class="img-block">
                                            <div class="front">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro15.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="back">
                                                <a href="product-page.php"><img
                                                        src="../assets/images/banner/pro16.jpg"
                                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                            </div>
                                            <div class="cart-info">
                                                <button tabindex="0" onclick="openCart()" title="Add to cart">
...
<br>
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="../assets/images/banner/background.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
                ...
                <div class="col">
                    <div class="product-4 product-m no-arrow">
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro17.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro17.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro18.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro18.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro19.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro19.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro20.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro20.jpg"
                        ...
                        <div class="product-box">
                            <div class="img-block">
                                <div class="front">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro21.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                </div>
                                <div class="back">
                                    <a href="product-page.php"><img src="../assets/images/banner/pro21.jpg"
                ...
                <div class="col-md-12">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="../assets/images/banner/background-2.jpg" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                    ...
                    <div class="slide-3 no-arrow">
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/banner/blog1.jpg"
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/banner/blog2.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
                        ...
                        <div class="col-md-12">
                            <a href="#">
                                <div class="classic-effect">
                                    <div>
                                        <img src="../assets/images/banner/blog3.jpg"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                    </div>
                                    <span></span>
                                </div>
            ...
            <div class="row category-border">
                <div class="col-sm-4 border-padding">
                    <div class="category-banner">
                        <div>
                            <img src="../assets/images/cat1.png" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                ...
                <div class="col-sm-4 border-padding">
                    <div class="category-banner">
                        <div>
                            <img src="../assets/images/cat2.png" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="category-box">
                            <a href="#">
                                <h2>women</h2>
                ...
                <div class="col-sm-4 border-padding">
                    <div class="category-banner">
                        <div>
                            <img src="../assets/images/cat3.png" class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="category-box">
                            <a href="#">
                                <h2>kids</h2>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/3-.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/4.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/5.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/6.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/7.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/8.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/25.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/10.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/11.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/12.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/13.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/14.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/16.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                    ...
                    <div class="theme-card">
                        ...
                        <div class="offer-slider slide-1">
                            <div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/17.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/18.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                            ...
                            <div>
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/19.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/20.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
                                ...
                                <div class="media">
                                    <a href="product-page.php"><img class="img-fluid blur-up lazyload"
                                            src="../assets/images/pro/21.jpg" alt=""></a>
                                    <div class="media-body align-self-center">
                                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                                class="fa fa-star"></i></div>
