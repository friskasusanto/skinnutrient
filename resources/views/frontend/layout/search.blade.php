                                            ...
                                            <div class="row margin-res">
                                                <div class="col-lg-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="../assets/img/produk/mix-mask.jpg" class="img-fluid blur-up lazyload bg-img produkkotak"></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="../assets/img/produk/mix-mask-2.jpg" class="img-fluid blur-up lazyload bg-img produkkotak" alt=""></a>
                                                            </div>
                                                ...
                                                <div class="col-lg-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="../assets/img/produk/purifying.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="../assets/img/produk/purifying-2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="cart-detail">
                                                                <a href="javascript:void(0)" title="Add to Wishlist">
                                                                    <i class="ti-heart" aria-hidden="true"></i>
                                                ...
                                                <div class="col-lg-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <a href="#"><img src="../assets/img/produk/hydrating.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="back">
                                                                <a href="#"><img src="../assets/img/produk/hydrating-2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                            </div>
                                                            <div class="cart-detail">
                                                                <a href="javascript:void(0)" title="Add to Wishlist">
                                                                    <i class="ti-heart" aria-hidden="true"></i>
