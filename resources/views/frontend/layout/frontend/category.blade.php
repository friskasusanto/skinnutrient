                                                ...
                                                <div class="col-xl-3 col-6 col-grid-box">
                                                    <div class="product-box">
                                                        <div class="img-wrapper">
                                                            <div class="front">
                                                                <img alt="" src="{{url('product/'.$c->image)}}" class="img-fluid blur-up lazyload bg-img">
                                                            </div>
                                                            <div class="back">
                                                            ...
                                                            <div class="cart-detail">
                                                                ...
                                                                <a href="#" data-toggle="modal" data-target="#modalDetail{{$c->id}}" title="Quick View">
                                                        ...
                                                        <div class="product-info">
                                                            <a href="{{url('/detailProduct', $c->slug)}}">
                                                                <h6 class="tekshitam">{{$c->name}}</h6>
                                                            </a>
                                                            <div class="rating">
                                                            ...
                                                            @else
                                                                ...
                                                                <a href="{{url('/session/tambahCart', $c->slug)}}" class="addcarthitam"><h4>+ Tambah keranjang</h4></a>
                                                                <h5 class="harga">
                                                                    Rp. {{number_format($c->price - ($c->discount /100 * $c->price), 0, ',', '.')}}
                                                                    <del>Rp. {{number_format($c->price, 0, ',', '.')}}</del>
                                                                </h5>
                                                                @else 
                                                                <a href="{{url('/session/tambahCart', $c->slug)}}" class="addcarthitam"><h4>+ Tambah keranjang</h4></a>
                                                                <h5 class="harga">
                                                ...
                                                <div class="container-fluid p-0">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-md-6 col-sm-12">
                                                            ...
                                                            <?php
                                                                $botanic = App\Model\Product::where('category_id', $category->id)->count();
                                                            ?>
