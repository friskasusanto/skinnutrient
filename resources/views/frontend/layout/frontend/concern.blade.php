                    ...
                    <div class="collection-content col">
                        <div class="page-main-content">
                            <div class="top-banner-wrapper">
                                <section class="mb-3">
                                    <a href="#"><img src="{{asset('frontend/assets/images/mega-menu/2.jpg')}}" class="img-fluid blur-up lazyload" alt=""></a>
                                </section>
                                <section class="mb-3">
                                    <a href="#"><img src="{{asset('frontend/assets/images/mega-menu/2.jpg')}}" class="img-fluid blur-up lazyload" alt=""></a>
                                </section>
                    ...
                    <div class="row">
                        <div class="col-lg-6  col-xs-12">
                            <div class="quick-view-img">
                                <img src="{{asset('url('product/'.$u->image)}}" alt="" class="img-fluid blur-up lazyload">
                            </div>
                        </div>
