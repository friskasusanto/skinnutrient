                    ...
                    <div class="col-sm-12">
                        <div class="main-menu border-section border-top-0">
                            ...
                            <div class="brand-logo layout2-logo">
                                <a href="#"><img src="{{asset('backends/assets/images/icon/logo/skinnutrient-logo.png')}}" class="img-fluid blur-up lazyload" alt=""></a>
                            </div>
                            <div class="menu-right pull-right">
                                <div class="icon-nav d-none d-sm-block">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="{{asset('backends/assets/images/icon/search.png')}}" onclick="openSearch()" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i></div>
                                        </li>
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            <div href="javascript:void(0)" onclick="openCart()"><img
                                                    src="{{asset('backends/assets/images/icon/cart.png')}}"
                                                    class="img-fluid blur-up lazyload" alt=""> <i
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="{{asset('backends/assets/images/mega-menu/shoes.jpg')}}"
