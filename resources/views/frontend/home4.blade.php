        ...
        <div class="slide-1 home-slider">
            <div>
                <div class="home  text-center">
                    <img src="{{asset('backends/assets/images/banner/Skin-Nutrient-Face-Masks.png')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
            ...
            <div>
                <div class="home text-center">
                    <img src="{{asset('backends/assets/images/banner/Skin-Nutrient_hand-Sanitiser-500ml.png')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <!--<div class="slider-contain">
            ...
            <div>
                <div class="home text-center">
                    <img src="{{asset('backends/assets/images/banner/SANITISER-TILE-BANNER-REVIEW2.png')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <!--<div class="slider-contain">
            ...
            <div>
                <div class="home text-center">
                    <img src="{{asset('backends/assets/images/banner/SANITISER-spray-new2.png')}}" alt="" class="bg-img blur-up lazyload">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <!--<div class="slider-contain">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="title3">
                        <h2 class="title-inner3">Langit Biru Di Depan</h2>
                        <div class="line"></div>
                    </div>
                    <div class="about-text">
                        <p>Pelajari bagaimana Skin Nutrient™ mendukung komunitas kami selama waktu yang tidak pasti ini.</p>
                    </div>
                    <div class="">
                        <h5 class=""><a href="#">BACA SELENGKAPNYA</a></h5>
                </div>
            </div>
        </div>
    </section> -->
            ...
            <div class="row partition2">
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{asset('backends/assets/images/sub-banner1s.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h2>Untuk Jerawat & Bekas Luka</h2>
                                    <h4>Dirancang untuk membersihkan, menargetkan & melindungi dari jerawat, melawan jerawat dan menyembuhkan bekas luka.</h4>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="{{asset('backends/assets/images/sub-banner2s.jpg')}}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h2>Untuk Kulit Sensitif</h2>
                                    <h4>Dicoba, diuji dan ditinjau oleh orang-orang dengan kulit sensitif.</h4>
                                </div>
                            </div>
                        </div>
                    </a>
...
>
    ...
    <div class="title1 section-t-space">
        ...
        <h4>Sudahkah Anda mencoba produk terlaris ini?</h4>
    </div>
                    ...
                    <div class="theme-tab">
                        ...
                        <div class="tab-content-cls">
                            <div id="tab-4" class="tab-content active default">
                                ...
                                @if(count($terbaik) != 0)
                                @foreach ($terbaik as $t)
                                    <div class="product-box">
                                        <div class="img-wrapper">
                                        <div class="lable-block"><span class="lable3">best</span> 
                                        @if ($t->product->discount != null)
                                        ...
                                        @endif
                                            ...
                                            <div class="back">
                                                <a href="{{url('/detailProduct', $t->product->slug)}}">
                                                    <img src="{{url('product/'.$t->product->image)}}" cclass="img-fluid blur-up lazyload bg-img" alt="">
                                                </a>
                                            </div>
    ...
    <section class="section-b-space beauty-about">
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-12 offset-xl-1 text-center"><img
                        src="{{asset('backends/assets/images/beauty/about-us.jpg')}}" alt="" class="img-fluid blur-up lazyload">
                </div>
                <div class="col-xl-5 col-lg-6 col-md-12">
                    <div class="about-section">
                        <div>
                            ...
                            <div class="about-text">
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque
                                    laudantium, totam rem aperiam.sit voluptatem accusantium doloremque laudantium,totam
                                    rem aperiam.</p>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="slide-7 no-arrow slick-instagram">
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/2.jpg')}}" class="bg-img"
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/3.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/4.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/9.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/6.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/7.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box"> <img src="{{asset('backends/assets/images/slider/8.jpg')}}" class="bg-img"
                                        alt="Avatar" style="width:100%">
                                    <div class="overlay"><i class="fa fa-instagram" aria-hidden="true"></i></div>
                                </div>
                            </a>
                    ...
                    <div class="slide-6 no-arrow">
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/1.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/2.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/3.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/4.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/5.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/6.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/7.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div>
                            <div class="logo-block">
                                <a href="#"><img src="{{asset('backends/assets/images/logos/8.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
