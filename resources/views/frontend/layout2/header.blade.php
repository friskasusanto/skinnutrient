                    ...
                    <div class="col-sm-12">
                        <div class="main-menu border-section border-top-0">
                            ...
                            <div class="brand-logo layout2-logo">
                                <a href="#"><img src="{{asset('backends/assets/images/icon/logo/skinnutrient-logo.png')}}"
                            ...
                            <div class="menu-right pull-right">
                                <div class="icon-nav d-none d-sm-block">
                                    <ul>
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="../assets/images/icon/heart-black.png"
                                                    class="img-fluid blur-up lazyload" alt=""> <i
                                                    class="ti-settings"></i>
                                            </div>
                                        </li>
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="../assets/images/mega-menu/shoes.jpg"
                            ...
                            <div class="icon-nav">
                                <ul>
                                    ...
                                    <li class="onhover-div mobile-setting">
                                        <div>
                                            <a href="login.php">
                                            <img src="../assets/images/icon/users.png" class="img-fluid blur-up lazyload" alt="">
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        <div href="javascript:void(0)" onclick="openCart()"><img
                                                src="../assets/images/icon/cart.png" class="img-fluid blur-up lazyload"
