                ...
                <div class="card-body">
                    ...
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="" name="name" required style="width: 100%" value="{{ucfirst($product->name)}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="" name="price" required style="width: 100%" value="{{ucfirst($product->price)}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <textarea type="text" class="form-control summernote" id="" name="description" required style="width: 100%" rows="4" >{{$product->description}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="" name="stock" required style="width: 100%" value="{{ucfirst($product->stock)}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="" name="min_price" required style="width: 100%" value="{{ucfirst($product->min_price)}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control pull-right" id="" name="max_price" required style="width: 100%" value="{{ucfirst($product->max_price)}}">
                                </div>
                            </div>
                        </div>
